  ...
  public: {
    Tables: {
      ...
      bulk_training_plan_exercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_training_plan_exercises_exercise_id_fkey"
            columns: ["exercise_id"]
            isOneToOne: false
            referencedRelation: "bulk_exercises"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "bulk_training_plan_exercises_plan_day_id_fkey"
            columns: ["plan_day_id"]
            isOneToOne: false
            referencedRelation: "bulk_training_plan_days"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "bulk_training_plan_exercises_source_system_exercise_id_fkey"
            columns: ["source_system_exercise_id"]
            isOneToOne: false
            referencedRelation: "bulk_exercises"
            referencedColumns: ["id"]
          },
      ...
      bulk_training_plan_template_days: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_training_plan_template_days_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "bulk_training_plan_templates"
            referencedColumns: ["id"]
          },
        ]
      }
      bulk_training_plan_template_exercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_training_plan_template_exercises_exercise_id_fkey"
            columns: ["exercise_id"]
            isOneToOne: false
            referencedRelation: "bulk_exercises"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "bulk_training_plan_template_exercises_template_day_id_fkey"
            columns: ["template_day_id"]
            isOneToOne: false
            referencedRelation: "bulk_training_plan_template_days"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      bulk_training_plans: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_training_plans_bulk_profile_id_fkey"
            columns: ["bulk_profile_id"]
            isOneToOne: false
            referencedRelation: "bulk_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "bulk_training_plans_source_template_id_fkey"
      ...
      bulk_training_session_exercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_training_session_exercises_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "bulk_training_sessions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "bulk_training_session_exercises_source_exercise_id_fkey"
          ...
          {
            foreignKeyName: "bulk_training_session_exercises_source_plan_exercise_id_fkey"
            columns: ["source_plan_exercise_id"]
            isOneToOne: false
            referencedRelation: "bulk_training_plan_exercises"
            referencedColumns: ["id"]
          },
        ]
      }
      bulk_training_session_sets: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_training_session_sets_session_exercise_id_fkey"
            columns: ["session_exercise_id"]
            isOneToOne: false
            referencedRelation: "bulk_training_session_exercises"
            referencedColumns: ["id"]
          },
        ]
      }
      bulk_training_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_training_sessions_bulk_profile_id_fkey"
            columns: ["bulk_profile_id"]
            isOneToOne: false
            referencedRelation: "bulk_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "bulk_training_sessions_source_plan_day_id_fkey"
          ...
          {
            foreignKeyName: "bulk_training_sessions_training_plan_id_fkey"
    ...
    Functions: {
      ...
      create_empty_bulk_training_plan: {
        Args: { _name: string }
        Returns: string
      }
      ...
      finish_bulk_training_session: {
        Args: { _confirm_incomplete?: boolean; _session: string }
        Returns: string
      }
      ...
      switch_to_empty_bulk_training_plan: {
        Args: { _name: string }
        Returns: string
      }
      ...
      username_available: {
        Args: { _caller: string; _username: string }
        Returns: boolean
      }
    }
    Enums: {
